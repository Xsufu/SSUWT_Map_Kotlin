package com.xolary.ssuwtmap.encryption


fun sha256(text: String): ByteArray {
    val ctx = Sha256Ctx()
    sha256Update(ctx, text.encodeToByteArray())
...
//    data[offset].toInt() and 0xff shl 16
...
fun ByteArray.toHexString() =
    fold("") { str, it -> str + (0xFF and it.toInt()).toString(16).padStart(2, '0') }
